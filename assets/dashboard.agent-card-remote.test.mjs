...
// The share URL = REMOTE_BASE (example.org) prefixed onto the tab's OWN /tabs/by-id/<uuid>/view path +
...
// ============================ remoteTabLink — compose the shareable WRITE remote URL for a TAB ============================
{
  ...
  assert.equal(noTok, "https://example.org/tabs/by-id/x/view", "tokenless → still absolute, no dangling token param");
