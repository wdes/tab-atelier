...
//      REAL DOM href = https://example.org/tabs/by-id/<uuid>/view?token=<page token> + rel=noreferrer.
...
async function main() {
  ...
  ok("(2) ⭐ the remote href is the ABSOLUTE amaury TAB-viewer URL (write)",
    remoteHref.startsWith(`https://example.org/tabs/by-id/${AID}/view`), `remoteHref=${remoteHref}`);
