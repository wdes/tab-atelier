...
//!
//! Declares an agent's **stable place in the workflow** — its phase and role —
//! for the harness dashboard. Unlike `set-context` (rewritten by the prompt hook
//! every turn and never persisted), `assignment` is set **once**, immune to the
//! hook, and persisted to `tabs.json`.
//!
